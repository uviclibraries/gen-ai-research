...
> **NOTE: If any of your professors do not allow the use of GenAI for any aspect of an assignment, then the only use permitted by UVic in those cases is to use GenAI for assignment feedback and NOT for use in any other way to complete the assignment.**
